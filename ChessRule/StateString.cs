...
namespace ChessRule
{
    public class StateString
    {
        ...
        // Method mapping piecetype to its respective character representation
        ...
        // Method which produces one row of piece placement data
        ...
        {
            if (!board.CanCaptureEnPassant(currentPlayer))  // If Cannot capture
            {
                sb.Append('-');
                return;
            }
